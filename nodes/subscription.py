...
class SubscriptionAgent:
    def subscription_agent(self):
        ...
        return Agent(
            ...
            goal="Your task is to assist the user with subscription issues, such as plan changes, new subscriptions, and cancellations. If the issue is not related to subscriptions, guide the user to the General Assistant.",
