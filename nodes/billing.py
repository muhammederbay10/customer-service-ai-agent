...
class BillingAgent:
    ...
    def billing_agent(self):
        ...
        return Agent(
            ...
            goal="Your task is to assist the user with billing issues, such as explaining charges, payment methods, and billing cycles but before that you need to authenticate the user. If the issue is not related to billing, guide the user to the General Assistant.",
